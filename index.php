        ...
        <div id="gallery">
            <? foreach ($gallery as $items): ?>
                <div class="col-lg-4" id="helped_<?= $items['id']; ?>">
                    <div><?= $items['date']; ?></div>
                    <p><img src="/template/images/pic<?php echo $items['id']; ?>.<?php echo $items['format']; ?>"
                            width="300" height="220" alt=""/></p>
                    <textarea cols="40" class="comment" title="#"
                              id="commentid-<?= $items['id']; ?>"><?= $items['comment']; ?></textarea><br/>
